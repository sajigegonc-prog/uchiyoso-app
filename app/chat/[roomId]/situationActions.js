...
const COMMON_POOL = [
  ...
  { place: 'ホグワーツの中庭', time: '昼休み', text: '中庭で休憩していた〇〇（申請した側）は、フィフィ・フィズビーで遊んでいる生徒をなんとなく眺めていた。ところがその生徒が着地に失敗し、こちらへ倒れ込んでくる。たまたま通りがかった〇〇（申請された側）も、その巻き添えになってしまった。' },
  {
    ...
    text: '廊下を歩いていた〇〇（申請した側）の目の前に、噛みつきフリスビーが突然飛んできた。とっさに身をかわしたものの、その先ではまだフリスビーに気づいていない〇〇（申請された側）が、こちらに向かって歩いてきていた。',
  },
  {
  ...
  {
    place: '温室前', time: '授業前後',
    text: '温室の前で列を作っていた〇〇（申請した側）、うっかり足を滑らせて肥料の袋を落としてしまい、辺り一面が土まみれに。隣にいた〇〇（申請された側）も巻き込まれてしまった。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: 'ふくろう小屋への階段', time: '朝',
    text: '手紙を出しに来た〇〇（申請した側）、階段の途中で足を止めて休んでいると、後ろから来た〇〇（申請された側）に軽くぶつかられてしまった。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: 'ホグワーツの空き教室', time: 'いつでも',
    text: '急な雨に降られて空き教室に駆け込んだ〇〇（申請した側）。少し遅れて、同じく雨宿りに来た〇〇（申請された側）も駆け込んできた。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: 'トロフィールーム', time: '放課後',
    text: '古いトロフィーの1つが独りでにぐらつき、けたたましい音を立てて床に転がり落ちた。慌てて周囲を見回した〇〇（申請した側）の目に映ったのは、同じく驚いて固まっている〇〇（申請された側）の姿だった。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: 'ホグワーツの{floor}階回廊(甲冑の並ぶ場所)', time: '夜',
    text: '通りかかった瞬間、1体の甲冑がひとりでに兜の面頬をカチャリと開閉させた。〇〇（申請した側）が思わず声を上げると、少し離れた場所で同じものを見ていた〇〇（申請された側）と目が合った。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: '魔法薬学の教室', time: '放課後',
    text: '提出し忘れた課題の薬を取りに戻った〇〇（申請した側）。瓶を持ち上げた拍子に薬が沸騰して、教室中に色とりどりの煙が充満してしまった。煙にむせながら逃げ込んだ廊下で、同じ理由で戻ってきていた〇〇（申請された側）と鉢合わせた。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: '医務室', time: 'いつでも',
    text: '軽い怪我でベッドに寝かされていた〇〇（申請した側）。仕切りのカーテンが急な隙間風でめくれ上がり、隣のベッドにいた〇〇（申請された側）と目が合ってしまった。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: '必要の部屋の前の廊下', time: 'いつでも',
    text: '1人になりたくて必要の部屋を求めて3回歩いた〇〇（申請した側）。現れた扉を開けると、同じ目的で歩いていたらしい〇〇（申請された側）と鉢合わせ、なぜか2人分の願いが混ざった部屋が出来上がっていた。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: 'ホグワーツ特急の通路', time: '出発直後',
    text: '満席の車両が続き、空いている席を探して通路を歩いていた〇〇（申請した側）。ようやく見つけた空席のコンパートメントに入ると、先に座っていたのは〇〇（申請された側）だった。',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: 'ホグワーツ特急の車内(お菓子ワゴン前)', time: '昼',
    text: 'お菓子ワゴンが通りかかり、〇〇（申請した側）は迷わず蛙チョコを買い求めた。同じタイミングで手を伸ばしていたのが〇〇（申請された側）で、お互い開封することになった。（蛙チョコ機能をお使いください）',
    excludeIf: (ocA, ocB) => isTeacher(ocA) && isTeacher(ocB),
  },
  {
    place: 'ゾンコの悪戯専門店', time: '休日の午後',
    text: '陳列棚の商品を眺めていた〇〇（申請した側）。うっかり触れた拍子に「くしゃみ煙玉」が作動し、店内に煙が充満して盛大なくしゃみの連鎖が起きてしまう。近くにいた〇〇（申請された側）も、その渦中に巻き込まれた。',
  },
  {
    place: 'ハニーデュークス', time: '休日の昼',
    text: '「異常な味」コーナーを〇〇（申請した側）が通りがかった時、なにかの拍子で高く積まれた箱の山がガラガラと崩れてきた。避けた先で、たまたま箱のひとつから飛び出した「ゴキブリ・ゴソゴソ豆板」がひとつ、〇〇（申請された側）の口に入っていくのを目撃してしまった。',
  },
  {
    place: 'ハニーデュークス', time: '休日の昼',
    text: '新作の蛙チョコを試食用に配っていた店員が、〇〇（申請した側）と〇〇（申請された側）の2人にちょうど同じタイミングで手渡してきた。（蛙チョコ機能をお使いください）',
  },
  {
    place: '三本の箒', time: '休日の夕方',
    text: '注文したはずのバタービールがなかなか来ないと思っていたら、店員が間違えて〇〇（申請した側）のテーブルに山盛りの料理を運んできてしまう。困惑していると、本来この料理を頼んだらしい〇〇（申請された側）が、隣のテーブルから声をかけてきた。',
  },
  {
    place: 'マダム・パディフットの喫茶店', time: '休日の午後',
    text: 'カップル向けの店内、1人で入るのが少し気まずかった〇〇（申請した側）。席がそこしか空いておらず、相席をお願いすることになった相手が〇〇（申請された側）だった。',
  },
  {
    place: 'J・ピピン魔法薬店', time: '休日の昼',
    text: '薬瓶を選んでいた〇〇（申請した側）。棚から取ろうとした{drug}の瓶が滑り落ち、同じく薬瓶を探していた隣の〇〇（申請された側）にかかってしまった！',
  },
  {
    place: 'フローリアン・フォーテスキューのアイスクリーム店', time: '休日',
    text: '新作アイスの試食を配っていた店員から、〇〇（申請した側）は思いがけず2つ分を渡されてしまう。1つ余ってしまい困っていると、隣で同じように余らせていたのが〇〇（申請された側）だった。',
  },
  {
    place: 'イーロップのふくろう百貨店', time: '休日',
    text: '店内のふくろうたちが一斉に鳴き始め、その中の1羽が籠から抜け出して店内を飛び回る騒ぎに。逃げ惑うふくろうを避けようとした〇〇（申請した側）の目の前に、同じく避難していた〇〇（申請された側）がいた。',
  },
  {
    place: 'フローリシュ・アンド・ブロッツ書店', time: '休日',
    text: '本の山を運んでいた店員が通路でバランスを崩し、積み上げられた本が雪崩のように崩れ落ちる。とっさに避けた先で、同じく巻き込まれていた〇〇（申請された側）と鉢合わせた。',
  },
  {
    place: 'マダム・マルキンの洋装店', time: '休日',
    text: '採寸用のメジャーが暴走し、〇〇（申請した側）の体に巻きつき始めたと思ったら、勢い余って隣にいた〇〇（申請された側）まで一緒にぐるぐると巻き込んでしまった。',
  },
  {
    place: 'ウィーズリー・ウィザード・ウィーズ', time: '休日',
    text: '陳列されていた新商品のいたずらグッズを〇〇（申請した側）が手に取った瞬間、盛大な音と煙を発して作動してしまう。近くにいた〇〇（申請された側）も、その煙をもろに浴びることになった。',
  },
  {
    place: '', time: '',
    text: '宿題のために急遽必要になった{book}を借りようと図書室に来た〇〇（申請した側）。ところが貸出表を見ると、そこにはすでに〇〇（申請された側）の名前が記されていた。',
  },
  {
    place: '', time: '',
    text: '足元に見慣れない小さな物が落ちているのに気づいた〇〇（申請した側）。拾い上げてみても持ち主の見当がつかず困っていると、ちょうど通りかかった〇〇（申請された側）に声をかけられた。',
  },
  {
    place: '', time: '',
    text: '自分の忘れ物を取りに戻った〇〇（申請した側）。ところが目当ての場所には、同じく忘れ物を取りに来たらしい〇〇（申請された側）の姿があった。',
  },
  {
    place: '', time: '',
    text: '突然の強風に、〇〇（申請した側）が持っていた紙の束が一斉に舞い上がってしまう。慌てて追いかけていると、飛んできた1枚を〇〇（申請された側）が偶然キャッチしてくれた。',
  },
  {
    place: '', time: '',
    text: '考えごとをしながら歩いていた〇〇（申請した側）。背後から近づいてきた足音に気づかず、声をかけられて飛び上がるほど驚いてしまった。振り返るとそこにいたのは〇〇（申請された側）だった。',
  },
]
const HOUSE_POOL = [
  ...
  { place: 'クィディッチ競技場の観覧席', time: '試合中', text: 'ブラッジャーが観客席の方へ逸れて飛んできて、悲鳴とともに一斉に身をかがめる観客たち。体勢を崩した〇〇（申請した側）が、隣にいた〇〇（申請された側）の方へ倒れ込んでしまった。' },
  { place: '大広間', time: '夕食のデザートタイム', text: 'デザートの盆に紛れて、なぜか蛙チョコの箱が一つ紛れ込んでいた。〇〇（申請した側）が首を傾げていると、隣の〇〇（申請された側）も同じものを見つけて驚いていた。せっかくなので二人で開けてみることに。（蛙チョコ機能をお使いください）' },
  { place: '自室(寮の寝室)', time: '朝', text: '差出人不明のフクロウ便が届き、開けてみると中には蛙チョコが1つ。同室の〇〇（申請した側）が〇〇（申請された側）に見せると、同じものが届いていたと分かった。（蛙チョコ機能をお使いください）' },
]
const HOUSE_SPECIFIC_POOL = [
  ...
  { house: 'ハッフルパフ', place: 'ハッフルパフ寮入口', time: '{time_lunch_dinner}', text: '授業からの帰り道、〇〇（申請した側）が寮の樽を開けようとリズムよく叩いていると、急いでいた生徒がぶつかってきて、そのリズムが狂ってしまった。とたんに樽から酢が噴き出し、〇〇（申請した側）は頭からお酢まみれに。ふと横を見ると、たまたま居合わせた〇〇（申請された側）も、同じくお酢まみれになっていた。' },
  ...
  { house: 'グリフィンドール', place: 'グリフィンドール寮入口', time: '{time_noon_night}', text: 'グリフィンドールの寮の入口で、太った婦人はなかなか〇〇（申請した側）の合言葉を聞いてくれない。最近覚えた歌を披露したくてたまらないらしく、オペラを熱唱し続けている。そこへ偶然、〇〇（申請された側）も寮に帰ってきた。太った婦人は、相変わらず熱唱中だった。' },
]
const GRADE_POOL = [
  ...
  { place: '大広間(組分け前の待機列)', time: '新学期の夜', text: '組分けを待つ列で、緊張のあまり杖を落としてしまった〇〇（申請した側）。拾ってくれたのが、すぐ後ろに並んでいた〇〇（申請された側）だった。' },
  { place: '温室(マンドレイクの植え替え中)', time: '授業中', text: '耳当てを外すタイミングを誤り、マンドレイクの悲鳴をまともに聞いてしまった〇〇（申請した側）。ふらついて倒れかけたところを、隣にいた〇〇（申請された側）に支えられた。' },
]
const AGE_POOL = [
  {
    place: '使われていない教室の陰', time: '消灯後',
    text: '消灯後、廊下を歩いていた〇〇（申請した側）の耳に、フィルチとミセス・ノリスの足音が近づいてくるのが聞こえた。とっさに近くの物陰に飛び込むと、そこには先に隠れていた〇〇（申請された側）がいた。',
  },
]
const TEACHER_POOL = [
  { place: '魔法省アトリウム', time: '出勤・退勤時', text: '噴水の水が急に勢いを増して吹き上がり、〇〇（申請した側）は水しぶきをまともに浴びてしまう。少し離れた場所にいた〇〇（申請された側）も、風向きが変わって同じように濡れてしまった。' },
  { place: '魔法省の電話ボックス型エレベーター', time: 'いつでも', text: '目的階のボタンを押したはずが、エレベーターが行き先を無視して勝手に別の階へ向かい出す。同じく閉じ込められていたのが〇〇（申請された側）だった。' },
  { place: 'ロンドンの赤い電話ボックス(外来入口)前', time: 'いつでも', text: 'バッジの受け取り口が詰まってしまい、〇〇（申請した側）は苦戦していた。後ろで同じく詰まった順番待ちをしていたのが〇〇（申請された側）だった。' },
]
const AGE_OR_TEACHER_POOL = [
  { place: '黒湖のほとり', time: '昼下がり', text: '湖面から巨大イカが姿を見せ、大きく水しぶきを上げた。岸辺にいた〇〇（申請した側）はまともにそれを浴びてしまい、少し離れた場所にいた〇〇（申請された側）も同じく濡れてしまった。' },
]
...
function buildPool(ocA, ocB) {
  ...
  const bothNonStudents = !isStudent(ocA) && !isStudent(ocB)
  const exactlyOneTeacher = isTeacher(ocA) !== isTeacher(ocB)
