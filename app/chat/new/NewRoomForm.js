      ...
      <div style={secStyle(step === 2)}>
        ...
        {selfPlay ? (
          <div style={{ marginBottom: 14 }}>
            ...
            {otherOcs.length === 0 && (
              <p style={{ fontSize: 12.5, color: '#8a8168', fontStyle: 'italic' }}>他に登録済みのOCがありません。</p>
            )}
              ...
              {otherOcs.map((oc) => (
                <label
                  ...
                  style={{
                    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6,
                    width: 76, padding: '10px 6px', cursor: 'pointer',
                    border: '1px solid #8a8168', background: '#fff',
                  }}
                >
                  ...
                  <div style={{
                    ...
                    background: '#211d17', border: '1px solid #211d17',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    color: '#f4eee0', fontWeight: 700, fontSize: 13, fontFamily: 'Georgia, serif',
                  }}>
                    {oc.icon_url ? (
                      <img src={oc.icon_url} alt={oc.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    ) : oc.name?.charAt(0)}
          ...
          <div style={{ marginBottom: 14 }}>
            <label style={labelStyle}>招待するフレンド</label>
            {friends.length === 0 && (
